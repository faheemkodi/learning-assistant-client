const TermsText = () => {
  return (
    <>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Kengram Edtech Private Limited, 1st Floor,
            Building No. 18/344, Valaprakandiyil, Cheruputhur, Mongam,
            Malappuram - 673642.
          </p>
        </li>
        <li>
      ...
      <p>
        These are the Terms and Conditions governing the use of the Service and
      ...
      <p>
        You represent that you are or over the age of 13. The Company does not
