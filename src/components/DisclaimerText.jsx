      ...
      <ul>
        <li>
          <p>
            ...
            this Disclaimer) refers to Kengram Edtech Private Limited, 1st
            Floor, Building No. 18/344, Valaprakandiyil, Cheruputhur, Mongam,
            Malappuram - 673642.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            ...
            the Company downloaded by You on any electronic device named Kengram
            Learning Assistant.
          </p>
        </li>
      </ul>
